...
$(document).ready(function(){
    ...
    $('.slideshow-home-left').vegas({
        slides: [
            { src: 'images/left-1.jpg' },
            { src: 'images/left-2.jpg' },
            { src: 'images/left-3.jpg' },
        ],
    ...
    $('.slideshow-home-right').vegas({
        slides: [
            ...
            { src: 'images/right-2.jpg' },
            { src: 'images/right-3.jpg' },
        ],
    ...
    $('.slideshow-about').vegas({
        slides: [
            { src: 'images/slide-1-about.jpg' },
            { src: 'images/slide-2-about.jpg' },
            { src: 'images/slide-3-about.jpg' },
        ],
